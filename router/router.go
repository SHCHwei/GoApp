...
func SetupRouter() *gin.Engine {
	...
	studentRouter := router.Group("/student", middleware.CheckSLogin())
	{
	...
	teacherRouter := router.Group("/teacher", middleware.CheckTLogin())
	{
	...
	lessonRouter := router.Group("/lesson", middleware.CheckTLogin())
	{
	...
	applyRouter := router.Group("/apply", middleware.CheckSLogin())
	{
    ...
    router.GET("/login", login.LoginInfo.SignOut)
